...
<div class="cfkef-license-box">
    ...
    <div class="wrapper-body">
        ...
        <div class="cfkef-license-upgrade-box">
            <p><?php esc_html_e('To unlock more features, consider ', 'cool-formkit'); ?><a href="https://coolformkit.com/pricing/?utm_source=<?php echo  esc_attr($first_plugin); ?>&utm_medium=inside&utm_campaign=get-pro&utm_content=plugins-dashboard" target="_blank"><?php esc_html_e('upgrading to Pro', 'cool-formkit'); ?></a>.
            </p>
        ...
        <div class="pro-plugin-buy cfkef-license-upgrade-box">
            ...
            <div class="pro-plugin-buy-buttons-con">
                ...
                <a class="button button-primary no-pro-buy-btn" target="_blank" href="https://coolformkit.com/?utm_source=<?php echo $first_plugin; ?>&utm_medium=inside&utm_campaign=get-pro&utm_content=plugins-dashboard">
