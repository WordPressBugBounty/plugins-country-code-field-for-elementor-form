	...
	public function show_deactivate_feedback_popup() {
		...
		$deactivate_reasons = array(
			'didnt_work_as_expected'         => array(
				'title'             => __( 'The plugin didn\'t work as expected.', 'country-code-field-for-elementor-form' ),
				'input_placeholder' => 'What did you expect?',
			),
			'found_a_better_plugin'          => array(
				'title'             => __( 'I found a better plugin.', 'country-code-field-for-elementor-form' ),
				'input_placeholder' => __( 'Please share which plugin.', 'country-code-field-for-elementor-form' ),
			),
			'couldnt_get_the_plugin_to_work' => array(
				'title'             => __( 'The plugin is not working.', 'country-code-field-for-elementor-form' ),
				'input_placeholder' => 'Please share your issue. So we can fix that for other users.',
			),
			'temporary_deactivation'         => array(
				'title'             => __( 'It\'s a temporary deactivation.', 'country-code-field-for-elementor-form' ),
				'input_placeholder' => '',
			),
			'other'                          => array(
				'title'             => __( 'Other reason.', 'country-code-field-for-elementor-form' ),
				'input_placeholder' => __( 'Please share the reason.', 'country-code-field-for-elementor-form' ),
			),
		);
		...
		<div id="cool-plugins-feedback-<?php echo esc_attr( $this->plugin_slug ); ?>" class="hide-feedback-popup">
			...
			<div class="cp-feedback-header">
				<div class="cp-feedback-title"><?php echo esc_html__( 'Quick Feedback', 'country-code-field-for-elementor-form' ); ?></div>
			...
			<div class="cp-feedback-form-wrapper">
				<div class="cp-feedback-form-title"><?php echo esc_html__( 'If you have a moment, please share the reason for deactivating this plugin.', 'country-code-field-for-elementor-form' ); ?></div>
				<form class="cp-feedback-form" method="post">
					...
					<input class="cp-feedback-terms-input" id="cp-feedback-terms-input" type="checkbox"><label for="cp-feedback-terms-input"><?php echo esc_html__( 'I agree to share anonymous usage data and basic site details (such as server, PHP, and WordPress versions) to support Country Code For Elementor Form Telephone Field improvement efforts. Additionally, I allow Cool Plugins to store all information provided through this form and to respond to my inquiry.', 'country-code-field-for-elementor-form' ); ?></label>
					</div>
	...
	function submit_deactivation_response() {
		if ( ! isset( $_POST['_wpnonce'] ) || ! wp_verify_nonce( sanitize_text_field(wp_unslash($_POST['_wpnonce']) ), '_cool-plugins_deactivate_feedback_nonce' ) || ! current_user_can( 'manage_options' )) {
			...
			$deactivate_reasons = array(
				...
				'other'                          => array(
					'title'             => __( 'Other', 'country-code-field-for-elementor-form' ),
					'input_placeholder' => __( 'Please share the reason.', 'country-code-field-for-elementor-form' ),
				),
			);

			$plugin_initial =  get_option( 'country_code_initial_version' );
			...
			$feedback_url       = CCFEF_FEEDBACK_URL.'wp-json/coolplugins-feedback/v1/feedback';
